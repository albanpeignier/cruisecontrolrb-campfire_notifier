...
Where you set your $CRUISE_HOME to be, usually ~/.cruise, there will
be a builder_plugins folder.  I have it setup to where I clone this plugin
to my $CRUISE_HOME folder and create a symlink from inside the builder_plugins
folder into the cruisecontrolrb-campfire-notifier folder.
...
Inside your projects folder, you'll have each project folder, and inside there you'll
have a cruise_config.rb file:

  Project.configure do |project|

    project.campfire_notifier.account               = 'ccontrol'
    project.campfire_notifier.password              = 'secret'
